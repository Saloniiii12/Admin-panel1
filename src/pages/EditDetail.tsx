      ...
      <div>
        ...
        <Card className="mb-6 ">
          <CardHeader className="flex bg-[#039342] rounded-lg">
            ...
            <h3 className="text-white">
              You can view professional details below:
            </h3>
          </CardHeader>
          <CardContent>
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                >
                  ...
                  <Button className="justify-end bg-[#039342] text-white">
                    Add Working Days
                  </Button>
                </div>
                        ...
                        >
                          ...
                          {day === "Wednesday" ? (
                            <span className="text-gray-500 text-sm">
                              Physio is not working on this day.
                            </span>
                          ) : (
        ...
        <Card className="mb-6">
          <CardHeader className="flex bg-[#039342] rounded-lg">
            ...
            <h3 className="text-white">
              You can view home care details below:
            </h3>
          </CardHeader>
