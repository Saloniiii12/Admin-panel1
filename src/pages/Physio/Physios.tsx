											...
											<td>
												<Popover>
													...
													<PopoverContent className="w-60  shadow-lg bg-white p-4 rounded-md ">
														...
														<p>
															Are you sure you want to approve this physiotherapist?Approving them will grant them
															access to the plateform,allowing them to provide services and manage thier profile
														</p>
