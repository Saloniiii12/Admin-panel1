...
import { ChevronDown, MoreVertical, Lock, Search, Eye, Info, Unlock } from "lucide-react";
												...
												>
													<DialogContent className="max-w-lg bg-white text-black">
														<DialogHeader>
															...
															<DialogDescription>Here are the details of the bill for this patient.</DialogDescription>
														</DialogHeader>
				...
				<TabsContent value="Blocked">
					...
					<div className="flex justify-between my-4">
						...
						<div className="flex gap-2">
							...
							<Button
								variant="outline"
								className="bg-[#039342] text-white"
							>
								{" "}
								Block Patient
								<Lock className="ml-2" />
