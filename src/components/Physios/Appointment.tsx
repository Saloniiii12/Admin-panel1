												...
												{selectedAppointment && (
													<div className="mt-4 space-y-2 text-sm text-gray-700">
														<p className=" flex justify-between ">
															<span className="font-semibold">Appointment Date:</span> {appt.date}
														</p>

														<p className=" flex justify-between ">
															<span className="font-semibold ">Appointment Time:</span> <span>{appt.time}</span>
														</p>
														<p className=" flex justify-between ">
															<span className="font-semibold ">Service Type:</span> <span>{appt.Type}</span>
														</p>
														<p className=" flex justify-between ">
															<span className="font-semibold ">Booking Date:</span> <span>{appt.booking}</span>
														</p>
														<p className=" flex justify-between ">
															<span className="font-semibold ">Total Amount:</span> <span>{appt.total}</span>
														</p>
														<p className=" flex justify-between ">
															<span className="font-semibold ">Payable Amount:</span> <span>{appt.payable}</span>
														</p>
														<p className=" flex justify-between ">
															<span className="font-semibold ">Payment Method:</span> <span>{appt.method}</span>
														</p>
														<p className=" flex justify-between ">
															<span className="font-semibold ">Payment Status:</span> <span>{appt.status}</span>
														</p>
														<p className=" flex justify-between ">
															<span className="font-semibold">Payment Date:</span> <span>{appt.PayDate}</span>
														</p>
													</div>
												)}
											</DialogContent>
													...
													<div className="p-2">
														...
														{activeTab === "payment" && (
															<div className="mt-0 space-y-2 text-sm text-gray-700">
																<p className=" flex justify-between ">
																	<span className="font-semibold">Consultation Charges:</span> {"₹960"}
																</p>

																<p className=" flex justify-between text-green-500">
																	<span className="font-semibold ">Physioplus Coin:</span>
																	<span>{"-₹0"}</span>
																</p>
																<p className=" flex justify-between text-green-500">
																	<span className="font-semibold ">Voucher Code:</span> <span>{"-₹0"}</span>
																</p>
																<hr />
																<p className=" flex justify-between">
																	<span className="font-semibold ">Total Bill</span> <span>{"₹960"}</span>
																</p>
															</div>
														)}
													</div>
											...
											>
												<DialogContent>
													<div className="mt-0 space-y-2 text-sm text-gray-700">
														...
														<p className=" flex justify-between ">
															<span className="font-normal">GST on plateform Fees</span>
															<span>{"-₹3.9"}</span>
														</p>
														<hr />
														<p className=" flex justify-between ">
															<span className="font-semibold ">Physio Earning</span>
															<span>{"₹74.5"}</span>
														</p>
													</div>
												</DialogContent>
