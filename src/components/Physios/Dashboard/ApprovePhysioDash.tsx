...
import { getApprovedPhysios } from "@/lib/api/physio";
...
const ApprovePhysioDash = ({ handleClickViewProp }: { handleClickViewProp: (id: string) => void }) => {
	...
	const { data, error, isLoading } = useQuery({
		...
		queryFn: () => {
			if (!searchText && !planName && !date && !serviceType) {
				return getApprovedPhysios(page);
			}
			return getApprovedPhysios(
				page,
				debouncedSearch,
				planName,
...
export default ApprovePhysioDash;
